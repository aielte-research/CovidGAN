...
class ClientAPI:
    ...
    def _gather_results():
        ...
        if cc.settings['network'].get('history', False) == True:
            results['gen_history'] = neighbourhood.gen_history
            results['disc_history'] = neighbourhood.disc_history
            results['fid_history'] = neighbourhood.fid_history
        else:
            results['gen_history'] = {}
            results['disc_history'] = {}
            results['fid_history'] = {}
