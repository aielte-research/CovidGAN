...
class Neighbourhood:
    ...
    def __init__(self):
        ...
        #Mixture weights assign a weight for each elemnt in neighbourhood (self too)
    ...
    def local_generators(self):
        ...
        #There can be more then one generator in a single node?
    ...
    def all_generators(self, sampling_size=None):
        #Returns all generators from neighbour populations 
        #(always concurrent_populations.generators, not clear how many 
        # generators in concurrent.populations, should be only one)
    ...
    def best_generators(self):
        #returns a Population of the best generators, from each member in the neighbourhood
    ...
    def _load_topology_details(self):
        ...
        #print("Client nodes: ", client_nodes, len(client_nodes))
